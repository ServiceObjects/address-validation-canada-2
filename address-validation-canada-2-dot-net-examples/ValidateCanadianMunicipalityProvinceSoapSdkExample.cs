...
{
    public class ValidateCanadianMunicipalityProvinceSoapSdkExample
    {
        public static void Go(string licenseKey, bool isLive)
        {
            Console.WriteLine("\r\n-------------------------------------------------------");
            Console.WriteLine("AVCA2 - ValidateCanadianMunicipalityProvince - SOAP SDK");
            Console.WriteLine("-------------------------------------------------------");
            ...
            CanadianAddressResponse response = avca2.ValidateCanadianMunicipalityProvince(
                Municipality, Province, PostalCode, licenseKey).Result;
