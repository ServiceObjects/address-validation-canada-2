...
async function ValidateCanadianAddressV2RestGo(licenseKey, isLive) {
    console.log("\n--------------------------------------------");
    console.log("AVCA2 - ValidateCanadianAddressV2 - REST SDK");
    console.log("--------------------------------------------");
...
export { ValidateCanadianAddressV2RestGo };