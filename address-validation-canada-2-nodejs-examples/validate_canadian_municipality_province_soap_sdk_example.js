...
async function ValidateCanadianMunicipalityProvinceSoapGo(licenseKey, isLive) {
    console.log("\n-------------------------------------------------------");
    console.log("AVCA2 - ValidateCanadianMunicipalityProvince - SOAP SDK");
    console.log("-------------------------------------------------------");
...
export { ValidateCanadianMunicipalityProvinceSoapGo };